...
class Camera2BasicFragment : Fragment(),ActivityCompat.OnRequestPermissionsResultCallback/*, FragmentCompat.OnRequestPermissionsResultCallback*/ {
  ...
  private fun showToast2(text: String){
    ...
    activity?.runOnUiThread{
      textView2!!.text = text
      textAngle1!!.text = drawView!!.getLHKAAngle().toString()
      textAngle2!!.text = drawView!!.getRHKAAngle().toString()
      textCnt!!.text = drawView!!.getSquartCnt().toString()
      if(drawView!!.getWrongPoseFlag())
  ...
  private fun classifyFrame() {
    ...
    if(drawView!!.getIsStand()){
      pose = "Stand"
    }
    else if(drawView!!.getIsSquart()){
      pose = "Squart"
    }
    else if(drawView!!.getIsNothingPose()){
      pose = "Middle"
    }
    else{
      pose = "init..."
