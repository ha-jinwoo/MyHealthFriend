...
class Camera2BasicFragment : Fragment(),ActivityCompat.OnRequestPermissionsResultCallback/*, FragmentCompat.OnRequestPermissionsResultCallback*/ {
  ...
  private fun showToast2(text: String){
    ...
    activity?.runOnUiThread{
      textView2!!.text = text
      textAngle1!!.text = Posestimation.LHKAAngle.toString()
      textAngle2!!.text = Posestimation.RHKAAngle.toString()
      textCnt!!.text =Posestimation.squartCnt.toString()
  ...
  private fun classifyFrame() {
    ...
    else if(Posestimation.isNothingPose){
      pose = "Nothing"
    }
    else{
      pose = "init..."
