...
class Posestimation {
    ...
    companion object{
        ...
        private fun Play_Sound(context: Context, sound:Int){
            ...
            if(!isPlaying) {
                ...
                if(sound == R.raw.one
                        ...
                        || sound == R.raw.nine
                        || sound == R.raw.ten
                        || sound == R.raw.standingcrunch_error
                )
                    delaySec = 1000
        ...
        fun calcCalorie(exercise:String, kg:Int): Int {
            ...
            when(exercise){
                "squart"-> return ((0.66 * 3.5 * kg * squartMet)/200).toInt() // 분당 15회 10회 기준
                "lunge"-> return ((0.66 * 3.5 * kg * lungeMet)/200).toInt() // 분당 15회 10회 기준
                "crunch"-> return ((0.33 * 3.5 * kg * crunchMet)/200).toInt() // 분당 60회 20회 기준
