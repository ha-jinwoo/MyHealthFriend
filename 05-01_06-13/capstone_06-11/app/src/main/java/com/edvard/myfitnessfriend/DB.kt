        ...
        fun postCalorieRequest(context: Context, queue:RequestQueue,data: HashMap<String, Any>):Boolean{
            ...
            val responseListener = Response.Listener<String?> { response ->
                try {
                    ...
                    val success = jsonObject.getBoolean("success")
                    if (success) {
                        Toast.makeText(context, "칼로리 소모 추가에 성공했습니다.", Toast.LENGTH_SHORT).show()
                        //Toast.makeText(context, jsonObject.getString("userCALORIE"), Toast.LENGTH_SHORT).show()
                    } else {
                        return@Listener
                    }
        ...
        fun postTimeRequest(context: Context, queue:RequestQueue,data: HashMap<String, Any>):Boolean{
            ...
            val responseListener = Response.Listener<String?> { response ->
                try {
                    ...
                    val success = jsonObject.getBoolean("success")
                    if (success) {
                        Toast.makeText(context, "시간 추가에 성공했습니다.", Toast.LENGTH_SHORT).show()
                        //Toast.makeText(context, jsonObject.getString("userCALORIE"), Toast.LENGTH_SHORT).show()
                    } else {
                        return@Listener
                    }
            ...
            val responseListener = Response.Listener<String?> { response ->
                try {
                    ...
                    if (success) {
                        ...
                        Toast.makeText(context, jsonObject.getString("monthCALORIE")+"cal", Toast.LENGTH_SHORT).show()
                    } else {
                        ret = false
                        return@Listener
                    }
            ...
            val responseListener = Response.Listener<String?> { response ->
                try {
                    ...
                    if (success) {
                        ...
                        Toast.makeText(context, jsonObject.getString("monthTOTALTIME"), Toast.LENGTH_SHORT).show()
                    } else {
                        ret = false
                        return@Listener
                    }
        ...
        fun getTotalCalorieRequest(context: Context, queue: RequestQueue, data: HashMap<String, Any>): Boolean {
            ...
            val responseListener = Response.Listener<String?> { response ->
                try {
                    ...
                    val success = jsonObject.getBoolean("success")
                    if (success) {
                        //AppStat.myStat.setMonthTime(jsonObject.getString("totalcalorie").toFloat())
                    } else {
                        ret = false
                        return@Listener
                    }
        ...
        fun getTotalTimeRequest(context: Context, queue: RequestQueue, data: HashMap<String, Any>): Boolean {
            ...
            val responseListener = Response.Listener<String?> { response ->
                try {
                    ...
                    val success = jsonObject.getBoolean("success")
                    if (success) {
                        //AppStat.myStat.setMonthTime(jsonObject.getString("totaltime").toFloat())
                    } else {
                        ret = false
                        return@Listener
                    }
