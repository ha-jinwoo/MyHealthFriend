...
class Camera2BasicFragment : Fragment(),ActivityCompat.OnRequestPermissionsResultCallback/*, FragmentCompat.OnRequestPermissionsResultCallback*/ {
  ...
  private fun showToast2(text: String){
    ...
    activity?.runOnUiThread{
      ...
      textAngle2!!.text = Posestimation.LNHKAngle.toString()
      textCnt!!.text = Posestimation.errTime.toString()
  ...
  private fun classifyFrame() {
    ...
    if(Posestimation.curExercise != "plank"){
      ...
      if(AppStat.currentExerciseTime/1000 >= 30 ){
        val mintent = Intent(context, TutorialActivity::class.java)
        if(AppStat.isExercising) {
          Posestimation.isPlaying = true
          AppStat.isExercising = false
          //Toast.makeText(context, Posestimation.max.toString(),Toast.LENGTH_SHORT).show()
