...
class MyPage : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if(AppStat.myStat.getIsLogin()){
            ...
            Toast.makeText(context, AppStat.myStat.gettotalTime().toInt().toString()+" abc", Toast.LENGTH_SHORT).show()
            Toast.makeText(context, AppStat.myStat.gettotalCal().toInt().toString() +" abc", Toast.LENGTH_SHORT).show()
