...
이 좌푯값의 상관관계를 적절하게 이용하면 사용자의 잘못된 운동 자세에 대한 실시간 피드백 구현할 수 있다.

코드 + 알고리즘 설명 : [자동 자세 교정 알고리즘](https://github.com/ha-jinwoo/CapStone-APP-ResultVideo/blob/master/%EC%9E%90%EC%84%B8%EA%B5%90%EC%A0%95%EC%95%8C%EA%B3%A0%EB%A6%AC%EC%A6%98.pdf)
